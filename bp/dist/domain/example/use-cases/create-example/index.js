...
// src/domain/example/use-cases/create-example/index.ts
var create_example_exports = {};
__export(create_example_exports, {
  createExampleRequest: () => createExampleRequest,
  createExampleSchema: () => createExampleSchema,
  default: () => create_example_usecase_default
});
module.exports = __toCommonJS(create_example_exports);
